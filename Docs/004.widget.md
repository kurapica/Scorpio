...
Style[dlg] = {
    ...
    GroupA = {
        ...
        Input = {
            ...
            -- The Label is a child property, the 
            -- default location is at the left of the
            -- element, it'll be used to display the
...
function comboBoxA:OnSelectedChange(value)
    print("The Gender is ", self.SelectedValue)
end

function comboBoxB:OnSelectedChange(value)
...
-- We can use the UpdateScrollChildRect method to
-- update the scroll child's size based on all items
-- in it
