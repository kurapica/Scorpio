...
do
    ...
    Unit.Disconnected           = Wow.FromUnitEvent("UNIT_HEALTH", "UNIT_CONNECTION"):Map(function(unit) return not UnitIsConnected(unit) end)
...
do
    ...
    Unit.ReadyCheckVisible      = Wow.FromUnitEvent(_ReadyCheckVisibleSubject):Map(function(unit) return _ReadyChecking > 0 and UnitGUID(unit) ~= nil end)
