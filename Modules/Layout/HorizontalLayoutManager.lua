...
--========================================================--
--             Scorpio Horizontal Layout Manager          --
--                                                        --
...
--========================================================--
Scorpio     "Scorpio.Layout.HorizontalLayoutManager" "1.0.0"
--========================================================--
...
class "HorizontalLayoutManager"   (function(_ENV)
    ...
    function RefreshLayout(self, frame, iter, padding)
        ...
        for i, child, margin in iter do
            ...
            totalWidth         = totalWidth + offsety + child:GetHeight()
            prev                = child
            spacing             = margin and margin.bottom or 0
        end

        totalWidth             = math.max(totalWidth + spacing + (padding and padding.bottom or 0), minHeight or 0)
        if math.abs(frame:GetHeight() - totalWidth) > 10 then
            frame:SetHeight(math.max(totalWidth, minHeight or 0))
        end
